...
INSERT INTO disciplina(idDisciplina,nome,c_horaria,area,idcurso)
VALUES("BD2","Banco de Dados 2",80,"Informática",1);

INSERT INTO atividade(id, tema, disciplina, dataConclusao, tipo)
VALUES 
(1,"Listas","DS","2025-03-10","Exercício"),
(2,"Consultas a uma tabela","BD2","2025-03-10","Lista de Exercícios");
...
/* EXCLUSÃO DE LINHA DE TABELA */
DELETE FROM disciplina WHERE idDisciplina="CC";
SELECT * FROM disciplina;

/* ATUALIZAÇÃO DE DADOS EM TABELA */
UPDATE curso
SET c_horaria = 3400
WHERE idcurso = 1;  
